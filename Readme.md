...
|UC.1-2| Turn own the temperature based on plan text and conditions |Local IA, N8N, home assistant|
...
|RSTR.3 | For the AI model selection, initially will be run by local models using OLLAMA. after this is stable, a cloud enterprise level model (i.e: claude) may be used. 
